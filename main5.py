...
def main():
    ...
    # genera nombre automático basado en el nombre del video original
    ...
    while True:
        ...
        for tr in tracks:
            ...
            # comprobar si la proyección está dentro del segmento
        ...
        out.write(frame)  # 🔹 guardar cada frame procesado
